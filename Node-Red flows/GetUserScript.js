/**
* This script is used in order to get the usernamae from the db on the remote server.
* @author TheHub
...
if ((msg.payload.indexOf("hashedEmail") !== -1) && (msg.payload.indexOf("[")==-1)){
    msg.payload = JSON.parse(msg.payload);
    msg.projection = JSON.parse('{}');
    msg.limit = 1;
