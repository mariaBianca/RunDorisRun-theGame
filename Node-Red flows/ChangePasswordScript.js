/**
* This script is used in order to change the already existing password in the database on the remote server.
* @author TheHub
...
msg.query =
    JSON.parse(msg.payload.substring(0, 34)+ '}');
msg.payload = JSON.parse('{' + msg.payload.substring(35));
return msg;

/*
msg.query =
    msg.payload.substring(1, 44);
msg.payload = JSON.parse('{' + msg.payload.substring(45));
return msg;
*/
